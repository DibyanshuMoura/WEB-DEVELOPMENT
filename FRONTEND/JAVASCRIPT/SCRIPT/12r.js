...
function resetScore() {
  document.querySelector('.resetScoreDiv').innerHTML = `
  <button class="resetScore yes">Yes</button>
  <button class="resetScore no">No</button>
  `;
...
function keyPlay(event) {
  ...
  else if (event.key === 'a') autoPilotPlayButton();
